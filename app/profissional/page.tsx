          ...
          <div className="bg-[#eef7f6] rounded-[28px] p-6 sm:p-8">
            ...
            {!editandoPerfil ? (
              <>
                ...
                {/* Documentação */}
                <div className="bg-white rounded-2xl p-5 mb-3.5">
                  <div className="text-xs font-extrabold uppercase tracking-wide text-gray-400 mb-2.5">Documentação</div>

                  <div className={`flex items-center gap-3 bg-gray-50 rounded-2xl p-3 ${perfil.curriculoUrl ? 'mb-2' : ''}`}>
